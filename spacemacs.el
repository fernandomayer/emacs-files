...
any user code."
  ...
  ;; Create rmd-mode fot Rmarkdown
  ;; From: http://stackoverflow.com/questions/16172345/how-can-i-use-emacs-ess-mode-with-r-markdown
  ;; Enable with M-x rmd-mode AND M-x R-mode AND M-x rmd-mode (again)
  (defun rmd-mode ()
    "ESS Markdown mode for rmd files"
    (interactive)
    (setq load-path
          (append (list "/home/fernando/spacemacs/polymode/" "/home/fernando/spacemacs/polymode/modes/")
                  load-path))
    (require 'poly-R)
